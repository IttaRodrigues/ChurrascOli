...
(3, 'Linguiça Toscana', 'Linguiça saborosa, ideal para churrasco.', '/img/linguica.jpg', 3),
(4, 'Picanha', 'Corte nobre, suculento e muito apreciado no Brasil.', '/img/picanha.jpg', 1),
(5, 'Tomahawk', 'Corte grande e impressionante, com osso e muito sabor.', '/img/tomahawk.jpg', 1);
(6, 'Panceta', 'Crocante e irresistível, prove com limão e se surpreenderá', '/img/panceta.jpg',3);